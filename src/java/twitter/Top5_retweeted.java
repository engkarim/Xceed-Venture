 ...
 * @author eams
 */
public class Top5_retweeted extends HttpServlet {
     ...
     */
    private static final String PROTECTED_RESOURCE_URL = "https://api.twitter.com/1.1/statuses/retweets_of_me.json?count=5";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            /****************** Store top 5 retweeted in mongo database *******************/

            //connecting to mongo DB
            
            Mongo m = new Mongo();
            DB db = m.getDB("twitter");
            DBCollection coll = db.getCollection("top5tweets");
